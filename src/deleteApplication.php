...
if (isset($_SESSION['username'])) {
    ...
    $cisResponseCode = $cis->deleteCISDataById('application', $_POST['appId']);

?>

<div class="modal fade" id="deleteApplicationModal" tabindex="-1" role="dialog" aria-labelledby="delteApplicationModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="delteApplicationModalLabel">Application</h5>
